...
class Llama(Model):
    def __init__(self):
        super().__init__(model_id = "meta-llama/Llama-3.1-8B-Instruct",
    ...
    def load_model(self):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(self.model_id, trust_remote_code=True, cache_dir="./data/models/llama")
    ...
    def get_prediction(self, string: str, user_id="default"):
        try:
            ...
            generation_kwargs = dict(full_prompt, max_new_tokens=500, temperature=0.8, repetition_penalty=1.1, do_sample=True, eos_token_id=self.tokenizer.eos_token_id, pad_token_id=self.tokenizer.eos_token_id, streamer=streamer)
        ...
        print(f"Time to run model: {end_time - start_time} seconds")
        return streamer
